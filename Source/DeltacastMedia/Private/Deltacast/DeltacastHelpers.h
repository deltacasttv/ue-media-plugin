...
namespace Deltacast::Helpers
{
	...
	[[nodiscard]] DELTACASTMEDIA_API bool IsYuvk(VHD_BUFFERPACKING BufferPacking);

	[[nodiscard]] DELTACASTMEDIA_API bool IsSingleLink(VHD_INTERFACE Interface);
	[[nodiscard]] DELTACASTMEDIA_API bool IsDual(VHD_INTERFACE Interface);
	...
	[[nodiscard]] DELTACASTMEDIA_API VHD_INTERFACE GetSingleLinkInterface(VHD_VIDEOSTANDARD VideoStandard, bool IsKeyEnabled);

	[[nodiscard]] DELTACASTMEDIA_API VHD_INTERFACE GetQuadLinkInterface(VHD_VIDEOSTANDARD VideoStandard, EQuadLinkType QuadLinkType, bool IsKeyEnabled);
	...
	inline static constexpr std::array<VHD_INTERFACE, 20> SdiInterfaces = {
		  ...
		  VHD_INTERFACE::VHD_INTERFACE_SD_DUAL,
        VHD_INTERFACE::VHD_INTERFACE_HD_DUAL,
        VHD_INTERFACE::VHD_INTERFACE_3G_A_DUAL,
        VHD_INTERFACE::VHD_INTERFACE_6G_2081_10_DUAL,
        VHD_INTERFACE::VHD_INTERFACE_12G_2082_10_DUAL,
        VHD_INTERFACE::VHD_INTERFACE_4XHD_QUADRANT_DUAL,
        VHD_INTERFACE::VHD_INTERFACE_4X3G_A_QUADRANT_DUAL,
        VHD_INTERFACE::VHD_INTERFACE_4X3G_A_425_5_DUAL,
		...
		std::array
	{
		...
		std::vector
		{
			// `VHD_INTERFACE_12G_2082_10_DUAL`
			VHD_VIDEOSTANDARD::VHD_VIDEOSTD_3840x2160p_50Hz,
			VHD_VIDEOSTANDARD::VHD_VIDEOSTD_3840x2160p_60Hz,
			VHD_VIDEOSTANDARD::VHD_VIDEOSTD_4096x2160p_48Hz,
			VHD_VIDEOSTANDARD::VHD_VIDEOSTD_4096x2160p_50Hz,
		...
		std::vector
		{
			// `VHD_INTERFACE_4XHD_QUADRANT_DUAL`
		...
		std::vector
		{
			// `VHD_INTERFACE_4X3G_A_QUADRANT_DUAL`
			VHD_VIDEOSTANDARD::VHD_VIDEOSTD_3840x2160p_50Hz,
			VHD_VIDEOSTANDARD::VHD_VIDEOSTD_3840x2160p_60Hz,
			VHD_VIDEOSTANDARD::VHD_VIDEOSTD_4096x2160p_48Hz,
			VHD_VIDEOSTANDARD::VHD_VIDEOSTD_4096x2160p_50Hz,
		...
		std::vector
		{
			// `VHD_INTERFACE_4X3G_A_425_5_DUAL`
			VHD_VIDEOSTANDARD::VHD_VIDEOSTD_3840x2160p_50Hz,
			VHD_VIDEOSTANDARD::VHD_VIDEOSTD_3840x2160p_60Hz,
			VHD_VIDEOSTANDARD::VHD_VIDEOSTD_4096x2160p_48Hz,
			VHD_VIDEOSTANDARD::VHD_VIDEOSTD_4096x2160p_50Hz,
